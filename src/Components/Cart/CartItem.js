...
export const CartItem = ({item}) => {
  ...
  const [itemQuantity,onChangeQuantity,updateItemInCartHandel]=UpdateItemInCartHook(item)
    return (
        ...
        <img width="160px" height="197px" src={item.img[0]} alt="" />
        <div className="w-100">
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex flex-row justify-content-between">
              <div className="d-inline pt-2 cat-text">{item.category}</div>
              <div onClick={deleteItemFromCartHandel} className="d-flex pt-2 " style={{ cursor: "pointer" }}>
          ...
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex flex-row justify-content-between">
              <div className="d-inline pt-2 d-flex">
                ...
                />
                <Button onClick={updateItemInCartHandel} className="btn btn-dark">حفظ</Button>
              </div>
